...
class SM100BlockScaledGemm1D1DRuntime final: public LaunchRuntime<SM100BlockScaledGemm1D1DRuntime> {
public:
    struct Args {
        GemmDesc gemm_desc;
    ...
    static std::string generate_impl(const Args& args) {
        // TODO: rename files
        return fmt::format(R"(
#include <deep_gemm/impls/sm100_blockscaled_gemm_1d1d.cuh>

using namespace deep_gemm;

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(&sm100_blockscaled_gemm_1d1d_impl<
        {}, {},
        {}, {},
        {}, {}, {},
        {}, {}, {},
...
static void sm100_blockscaled_gemm_1d1d(const torch::Tensor& a, const torch::Tensor& sfa,
    ...
    // Launch
    const SM100BlockScaledGemm1D1DRuntime::Args args = {
        .gemm_desc = desc,
        .gemm_config = config,
    ...
    const auto code = SM100BlockScaledGemm1D1DRuntime::generate(args);
    const auto runtime = compiler->build("sm100_blockscaled_gemm_1d1d", code);
    SM100BlockScaledGemm1D1DRuntime::launch(runtime, args);
}
